        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3.5 md:space-y-4">
              <li>
                <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(schoolInfo.address.full)}`} target="_blank" rel="noopener noreferrer" className="flex gap-3 text-gray-400 text-sm hover:text-white transition-colors">
                  <MapPin size={18} className="text-secondary shrink-0 mt-0.5" />
                  <span className="break-words">{schoolInfo.address.full}</span>
                </a>
              </li>
              <li>
